...
//	public static int time = 0;    //the time the user chose to continue auto run
	 ...
	 */
	int min_wait = 1; //minimum wait time in seconds before finding finish screen
	int max_wait = 69; //maximum wait time in seconds before finding finish screen
		...
		ActionListener timeRecorder = new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if(((JButton)e.getSource()).equals(cairos)) {
					cairos_bool = true;
					System.out.println("cairos button pressed");
				}
				if(((JButton)e.getSource()).equals(raid)) {
					raid_bool = true;
					System.out.println("raid button pressed");
				}
...
//		cairos.addActionListener(new ActionListener(){
//			public void actionPerformed(ActionEvent e) {
//				System.out.println("cairos button pressed");
//				cairos_bool = true;
//				frame2= new JFrame();
					...
					public void run() {
						...
						try {
							if(mouse.check("out of energy")) {
								System.out.println("out of energy detected");
//								mouse.moveMouse("plus");
